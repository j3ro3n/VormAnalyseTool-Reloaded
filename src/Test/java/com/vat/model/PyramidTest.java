...
class PyramidTest {
    ...
    @Test
    void getData(){
        Pyramid pyramid = new Pyramid(11,6,5);

        HashMap<String, Integer> data = pyramid.getData();

        assertEquals(11,(int) data.get("length"));
        assertEquals(6,(int) data.get("width"));
        assertEquals(5,(int) data.get("height"));
    }
